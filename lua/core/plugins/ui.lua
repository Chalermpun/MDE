...
return {
    ...
    keys = {
      ...
      { "<leader>snd", function() require("noice").cmd("disable") end, desc = "Disable All" },
      { "<leader>snm", function() require("noice").cmd("dismiss") end, desc = "Dismiss All" },
      { "<leader>sne", function() require("noice").cmd("enable") end, desc = "Enable All" },
